<?php
	...
	$objResult = mysqli_fetch_array($objQuery,MYSQLI_ASSOC);
		...
		$strSQL1 = "UPDATE User SET Username = '".$_POST["username"]."',Password = '".$_POST["password"]."',FullName = '".$_POST["fullname"]."',Email = '".$_POST["email"]."',Update_Date = '$Start_key_in_date'
		...
		//$objResult1 = mysqli_fetch_array($objQuery1,MYSQLI_ASSOC);
				...
				echo "<script>alert('คุณได้แก้ไขข้อมูลเรียบร้อยแล้ว');</script>";
