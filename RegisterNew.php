	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="content d-flex justify-content-center align-items-center">
				...
				<!-- Registration form -->
				<form action="save_register.php" class="flex-fill" name="form1" method="post">
					<div class="row">
							...
							<div class="card mb-0">
								<div class="card-body">
									<div class="text-center mb-3">
										...
										<h5 class="mb-0">ลงทะเบียนสมาชิก</h5>
									...
									<div class="row">
										<div class="col-md-6">
											<input type="text" class="form-control" id="username" name="username" placeholder="ชื่อผู้ใช้ระบบ" onblur="check_user(this.id, '')" >
										</div>

										<div class="col-md-6">
											<div class="form-group form-group-feedback form-group-feedback-right">
												<input type="email" class="form-control" id="email" name="email" onblur="check_email(this.id,'')" placeholder="อีเมล์">
												<div class="form-control-feedback">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group form-group-feedback form-group-feedback-right">
												<input type="password" class="form-control" id="password" name="password" placeholder="รหัสผ่าน" onchange="checkPwd(this.id, $('#password').attr('id'))">
												<div class="form-control-feedback">
										...
										<div class="col-md-6">
											<div class="form-group form-group-feedback form-group-feedback-right">
												<input type="password" class="form-control" id="conpassword" name="conpassword" onchange="checkPwd2(this.id, $('#password').attr('id'))" placeholder="ยืนยันรหัสผ่าน">
												<div class="form-control-feedback">
													<i class="icon-user-lock text-muted"></i>
												</div>
											</div>
									...
									<br>
								        ...
								        <button type="button" class="btn bg-danger-400 btn-labeled btn-labeled-right" name="btnback" id="btnBack" onclick="location.href='login.php';"><b><i class="icon-reset"></i></b>กลับสู่หน้าจอหลัก</button>
